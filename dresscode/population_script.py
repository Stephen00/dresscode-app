...
def main():
    ...
    articles = [
        ...
        {'title': "Why C++ is terrific",
         'paragraph': ["Praesent eu rutrum lectus, sit amet tempor sem. Nam varius, risus at sodales consectetur, sapien magna suscipit metus, non congue orci purus a nibh. Nulla est sem, dictum non interdum et, luctus at lacus. Pellentesque sollicitudin congue rhoncus. Donec porta laoreet sollicitudin. Fusce lacinia eleifend arcu et eleifend. Aenean in tempus mi, ac mattis enim. Ut a facilisis orci. Nunc interdum lobortis lacus, at tristique nisl placerat sit amet. Nullam a mattis quam.", "This would be paragraph 2 within the paragraph field", "Wait! This is Paragraph 3"],
         'media': None, 'tags': []},
    ]
